...
<!-- <div class="error_popup">
	...
	<div class="error_popup_msg"></div>
</div> -->
<?php wp_footer(); ?>
<div class="error_popup pod_popup">
	<div class="close_popup pod_popup_close" style="display:block">x</div>
	<div class="error_popup_msg"><?php _e('For service in your area please call 0800 107 8422','storage'); ?></div>
</div>

<?php do_action('mfn_demo_builder'); ?>
<?php if(is_checkout()) {email_quote_popup(); }  ?>
</body>
</html>
